...
export default async function Contact() {
	return (
		<div className="flex flex-col w-full h-screen">
			<div className="flex flex-row w-full h-8 shrink-0 bg-neutral-800 items-center gap-6 px-4 border-2 border-solid border-amber-50">
			...
			<div className="flex flex-1 min-h-0 flex-row w-full bg-stone-500">
				<div className="flex flex-col w-60 shrink-0 bg-blue-500">
			...
			<div className="w-full h-5 shrink-0 bg-neutral-800 flex flex-row items-center gap-6 px-4 border-2 border-solid border-amber-50">
