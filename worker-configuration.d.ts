/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: c868191ca851636d4479214961e60654)
...
declare namespace Cloudflare {
	...
	interface Env {
		PORTFOLIO_VECTORIZE: VectorizeIndex;
		AI: Ai;
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		GROQ_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "GROQ_API_KEY">> {}
}
